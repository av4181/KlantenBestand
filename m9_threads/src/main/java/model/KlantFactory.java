...
public class KlantFactory {
    ...
    public static Klant newFilledKlant(long id, String voornaam, String achternaam, String email, KlantType type, double btw, LocalDate aanmaakDatum, boolean redflag) {
